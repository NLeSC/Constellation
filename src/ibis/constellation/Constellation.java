...
public interface Constellation {
     ...
     * 
     * @param job the Activity to submit
    ...
    /**
     * Is this Constellation instance the master in its Pool ? 
     * 
     * @return if this Constellation instance is the master in its Pool.
     */
     ...
     * 
     * This ConstellationIdentifier can be used to uniquely refer to a running Constellation instance. It is also used as part 
     * of an ActivityIdentifer.
     * 
     * @return a ConstellationIdentifier that uniquely identifies this Constellation instance. 
     */
