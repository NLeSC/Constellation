 ...
 * a multiple-core processor, some specialized hardware, or an entire cluster. It is up to the application how executors represent
 * the hardware. Constellation provides the {@link SimpleExecutor} implementation, but applications may provide others. A
 * {@link ExecutorContext} provides labels to classify the capabilities of the executor.
 *
 * Executors are member of a {@link StealPool}, and are able to steal activities from another {@link StealPool}. These steal pools
 * are to be provided to the constructor.
 *
